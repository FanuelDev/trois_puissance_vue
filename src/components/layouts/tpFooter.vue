        ...
        <div class="row py-5">
          <div class="col-md-3 pr-5">
            <div class="border-white">
              <h5 class="text-white title italic fw-bold">Liens Rapides</h5>
            </div>
            <div>
              <ul class="my-4 ul">
          ...
          <div class="col-md-4 px-5">
            <div class="border-white">
              <h5 class="text-white title italic fw-bold">Liens Utiles</h5>
            </div>
            <div>
              <ul class="my-4 ul">
            ...
            <div class="border-white mt-4">
              <h5 class="text-white title italic fw-bold">Contacts</h5>
            </div>
            <div>
              <ul class="my-4 ul">
                <li>
                  <a href="#"
                    ><i class="fa fa-phone mr-2" aria-hidden="true"></i> +228 99 00 99 00</a
                  >
                </li>
                <li>
                  <a href="#"
          ...
          <div class="col-md-5 pl-5">
            <div class="border-white">
              <h5 class="text-white title italic fw-bold">News Letters</h5>
            </div>
            <div class="mb-5 mt-3">
              <p class="text-white">
            ...
            <div class="pyy-6">
              <div class="input-group px-1">
                <input type="text" class="form-control input" placeholder="mail..." />
      ...
      <div class="container">
        <div class="row py-4">
          <div class="d-flex justify-content-between">
            ...
            <small class="" style="font-size: 11px">Powered by Agence 07</small>
          </div>
        </div>
      </div>
    </div>
