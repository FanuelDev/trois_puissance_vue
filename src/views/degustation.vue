<template>
  ...
  <div class="bg-primary p-4">
    <h2 class="text-center text-white title">DEGUSTATION</h2>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 d-flex justify-content-center">
        <div>
          ...
          <p class="text-center mt-4">Carton de 6 bouteille de 75 cl</p>
          <div class="mt-4 bg-light text-center p-4">
            <button class="btn btn-primary">COMMANDEZ MAINTENANT</button>
          </div>
        </div>
      </div>
    </div>
